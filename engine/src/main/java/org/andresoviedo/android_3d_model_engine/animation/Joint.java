 ...
 * shader and is used to transform vertices. It is a menu_item-space transform that
 ...
 * transform in menu_item-space, but inversed.
 *
 * @author andresoviedo
 */
public class Joint {
     ...
     * created. This calculates the menu_item-space bind transform of this joint
     * like so: </br>
     * </br>
     * {@code bindTransform = parentBindTransform * bindLocalTransform}</br>
     * </br>
     * where "bindTransform" is the menu_item-space bind transform of this joint,
     * "parentBindTransform" is the menu_item-space bind transform of the parent
     * joint, and "bindLocalTransform" is the bone-space bind transform of this
     * joint. It then calculates and stores the inverse of this menu_item-space bind
     ...
     * the menu_item's origin (menu_item-space). The inverse bind transform is simply
     * that but inverted.
     *
     * @param data
     ...
     * menu_item-space) to the joint's desired animation pose (also in menu_item-space).
     * This matrix is calculated by taking the desired menu_item-space transform of
     * the joint and multiplying it by the inverse of the starting menu_item-space
    ...
    /**
     * This returns the inverted menu_item-space bind transform. The bind transform
     * is the original menu_item-space transform of the joint (when no animation is
     ...
     * the shader.
     *
     * @return The inverse of the joint's bind transform (in menu_item-space).
     */
